        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.background }}>
            <ScrollView>
                <View style={{ padding: 24 }}>
                    <Text style={{ fontSize: 24, fontWeight: "bold", color: COLORS.text, marginBottom: 24 }}>Profil Mitra</Text>
                    ...
                    <View style={{ backgroundColor: COLORS.surface, borderRadius: 12, padding: 16, marginBottom: 24 }}>
                        <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 16 }}>
                            <View style={{ width: 60, height: 60, borderRadius: 30, backgroundColor: COLORS.primary + "20", alignItems: "center", justifyContent: "center" }}>
                                <Text style={{ fontSize: 24, fontWeight: "bold", color: COLORS.primary }}>{profile?.full_name?.charAt(0) || "U"}</Text>
                            </View>
                            <View style={{ marginLeft: 16 }}>
                                <Text style={{ fontSize: 18, fontWeight: "bold", color: COLORS.text }}>{profile?.full_name || "Pengguna"}</Text>
